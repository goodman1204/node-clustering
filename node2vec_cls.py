...
def training(args):
    ...
    G = nx.from_scipy_sparse_matrix(adj_init)
    print("graph node number:",G.number_of_nodes())
    ...
    node2vec = Node2Vec(G, dimensions=32, walk_length=80, num_walks=10, workers=20)
...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='node2vec', help="models used for clustering: gcn_ae,gcn_vae,gcn_vaecd")
