...
def training(args):
    ...
    # print("adj data type:{}".format(type(adj)))
    ...
    for epoch in range(args.epochs):
        ...
        if args.model =='gcn_vaecd':
            ...
            recovered_u, mu_u = model(features_training, adj_norm)
...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='gcn_ae', help="models used for clustering")
