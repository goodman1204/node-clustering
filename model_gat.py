...
class GCNModelVAECE(nn.Module):
    def __init__(self, input_feat_dim, n_nodes, hidden_dim1, hidden_dim2, dropout,args):
        ...
        # self.gc2 = GraphConvolution(hidden_dim1, hidden_dim2, dropout, act=lambda x: x)
        # self.gc3 = GraphConvolution(hidden_dim1, hidden_dim2, dropout, act=lambda x: x)
        self.gc1 = SpGAT(input_feat_dim,hidden_dim1,hidden_dim1,dropout,alpha=0.2,nheads=3)
        self.gc2 = SpGAT(hidden_dim1,hidden_dim2,hidden_dim2,dropout,alpha=0.2,nheads=3)
        self.gc3 = SpGAT(hidden_dim1,hidden_dim2,hidden_dim2,dropout,alpha=0.2,nheads=3)
        # self.gc2 = Linear(hidden_dim1,hidden_dim2,act=lambda x:x)
        # self.gc3 = Linear(hidden_dim1,hidden_dim2,act=lambda x:x)
        # self.dc = InnerProductDecoder(dropout, act=lambda x: x)
        self.dc = InnerDecoder(dropout, act=lambda x: x)
        ...
        self.pi_=nn.Parameter(torch.FloatTensor(args.nClusters,).uniform_(),requires_grad=True)
    ...
    def loss(self,x,adj,labels, n_nodes, n_features, norm, pos_weight,L=1):
        ...
        # return L_rec_u , L_rec_a , -20*KLD_u_c ,-KLD_a , -gamma_loss, -0.01*mutual_dist
        return L_rec_u , L_rec_a , -20*KLD_u_c ,-KLD_a ,  -0.01*mutual_dist
